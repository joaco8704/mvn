...
public final  class panelaks_impl extends GXWebPanel
{
   public panelaks_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public panelaks_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( panelaks_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeValue( "Panel AKS") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20214291046425", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.idquilmes.panelaks", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      if ( httpContext.isAjaxRequest( ) )
      {
         httpContext.ajax_rsp_assign_sdt_attri("", false, "vUPLOADEDFILES", AV5UploadedFiles);
      }
      else
      {
         httpContext.ajax_rsp_assign_hidden_sdt("vUPLOADEDFILES", AV5UploadedFiles);
      }
      if ( httpContext.isAjaxRequest( ) )
      {
         httpContext.ajax_rsp_assign_sdt_attri("", false, "vFAILEDFILES", AV6FailedFiles);
      }
      else
      {
         httpContext.ajax_rsp_assign_hidden_sdt("vFAILEDFILES", AV6FailedFiles);
      }
   }
   ...
   public void wb0J0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.idquilmes.GxWebStd.gx_label_ctrl( httpContext, lblTextblock1_Internalname, "PANEL AKS", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_PanelAKS.htm");
         ...
         ucFileupload1.setProperty("UploadedFiles", AV5UploadedFiles);
         ucFileupload1.setProperty("FailedFiles", AV6FailedFiles);
   ...
   public void start0J2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Panel AKS", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void strup0J0( )
   {
      ...
      {
         /* Read saved SDTs. */
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( "vUPLOADEDFILES"), AV5UploadedFiles);
         httpContext.ajax_req_read_hidden_sdt(httpContext.cgiGet( "vFAILEDFILES"), AV6FailedFiles);
         /* Read saved values. */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20214291046431", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("panelaks.js", "?20214291046431", false, true);
         httpContext.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
      }
   ...
   public void initialize( )
   {
      ...
      bodyStyle = "" ;
      GXKey = "" ;
      AV5UploadedFiles = new GXBaseCollection<com.idquilmes.SdtFileUploadData>(com.idquilmes.SdtFileUploadData.class, "FileUploadData", "ID_Quilmes", remoteHandle);
      AV6FailedFiles = new GXBaseCollection<com.idquilmes.SdtFileUploadData>(com.idquilmes.SdtFileUploadData.class, "FileUploadData", "ID_Quilmes", remoteHandle);
      GX_FocusControl = "" ;
      sPrefix = "" ;
   ...
   private GXBaseCollection<com.idquilmes.SdtFileUploadData> AV5UploadedFiles ;
   private GXBaseCollection<com.idquilmes.SdtFileUploadData> AV6FailedFiles ;
}
